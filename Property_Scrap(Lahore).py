...
filePath = 'E:/BSCS/3rd_Semester_Data/DSA_Lab/MidTerm_Project/CS261F22PID42/PropertyDataByCities/AllPropertyData.csv'
...
with open(filePath,'a', newline='') as outfile:
    ...
    urls = "https://www.zameen.com/Rentals/Lahore-1-"
